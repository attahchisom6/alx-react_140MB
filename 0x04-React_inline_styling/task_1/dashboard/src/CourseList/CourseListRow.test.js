...
describe("Test the course list Component", () => {
  ...
  it("tests if the component renders one cell with colSpan=2 when textSecondCell=null", () => {
    ...
    expect(component.find("tr").childAt(0).html()).toEqual('<th colSpan="2" style="background-color:#deb5b545">Some text</th>')
  });
  ...
  it("verifies that the component renders two cells when textSecondCell is not null", () => {
    ...
    expect(component.find("tr").childAt(0).html()).toEqual('<th style="background-color:#deb5b545">th ist text</th>');
    expect(component.find("tr").childAt(1).html()).toEqual('<th style="background-color:#deb5b545">th 2nd text</th>');
  });
